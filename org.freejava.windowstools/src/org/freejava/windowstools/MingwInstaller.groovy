...
class MingwInstaller {
	void install(String path) {
		...
		def url = "http://nchc.dl.sourceforge.net/project/mingw/Automated%20MinGW%20Installer/mingw-get/mingw-get-0.3-alpha-2.1/mingw-get-0.3-mingw32-alpha-2.1-bin.zip"
